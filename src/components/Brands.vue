...
<script>
  ...
  props: ['tabs'],
    ...
    data: () => ({
      ...
      menuVisible: false,
      ingredients: [
          {id: 0, name: '111111Салями (Мраморная)(100гр)', cost: 90, image:'https://upload.wikimedia.org/wikipedia/commons/1/18/Salami_aka.jpg', selected: null,
        		active:false},
          {id: 1, name: '1111111Пармезан(Италия)(100гр)', cost: 55, image:'https://ichef.bbci.co.uk/news/976/cpsprodpb/ABBB/production/_105436934_c6128ed2-1e89-4653-abde-f1092a82e2be.jpg', selected: null ,
        		active:false},
          {id: 2, name: '111111111Грибы(Вешенки)(100гр)', cost: 150, image:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTFmLQb3rUdVkXDdWVV40wSpxar-CPVvAKcnivg0CqbBX1RJOK6', selected: null,
        		active:false},
